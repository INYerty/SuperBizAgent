...
public class ChatService {
    ...
    public DashScopeChatModel createStandardChatModel(DashScopeApi dashScopeApi) {
        //temperature 代表思想的发散度，当temperature值越小，生成的就越死板AI 选词： “学校”、“上班”、“公园”。 结果： “今天我们要去上班。”
        //temperature 越大，生成的越自由，越有创意，AI 选词： “看海”、“吃火锅”、“逃离地球”。 结果： “今天我们要去远方的海边看日落。”
        //如果 temperature 再次增大 AI 选词： “量子跳跃”、“咀嚼时钟”、“变成一棵树”。  结果： “今天我们要去咀嚼那片紫色的虚无并量子跃迁。”

        //maxToken指的是生成的最大长度，当 maxToken 值越小，生成的越短，越精简。 1 token ≈ 0.75 英文单词  1 token ≈ 1~2 个中文字符

        // topP 代表 我将选中若干个词 ，条件是这些词经过从大到小排序之后，选中前n个使得其概率累加起来不超过topP所指定的值
